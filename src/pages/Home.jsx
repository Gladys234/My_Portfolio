...
const Home = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      >
        Hello, I'm <span className="text-blue-600 dark:text-blue-400">Gladys</span>
      </motion.h1>
      <motion.p
      ...
      >
        A Cybersecurity Enthusiast passionate about building secure and modern web applications.
       </motion.p>
