  ...
  return (
    <section className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-100 py-16 px-6 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          I’m <span className="font-semibold text-blue-600 dark:text-blue-400">Gladys</span>,  
          I’m a cybersecurity practitioner who finds and fixes security gaps
          before they become problems. I specialize in threat hunting, vulnerability
          management, and secure-by-design development to keep systems and data safe.
        </motion.p>
